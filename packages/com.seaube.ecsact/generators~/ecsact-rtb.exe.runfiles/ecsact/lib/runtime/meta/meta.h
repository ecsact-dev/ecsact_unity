...
#			ifdef __cplusplus
#				define ECSACT_META_API extern "C" __declspec(dllexport)
#			else
#				define ECSACT_META_API extern __declspec(dllexport)
#			endif
#		else
#			ifdef __cplusplus
#				define ECSACT_META_API extern "C" __declspec(dllimport)
#			else
#				define ECSACT_META_API extern __declspec(dllimport)
#			endif
#		endif
#	else 
#		ifdef ECSACT_META_API_EXPORT
#			ifdef __cplusplus
#				define ECSACT_META_API extern "C" __attribute__((visibility("default")))
#			else
#				define ECSACT_META_API extern __attribute__((visibility("default")))
#			endif
#		else
#			ifdef __cplusplus
#				define ECSACT_META_API extern "C"
#			else
#				define ECSACT_META_API extern
#			endif
#		endif
#	endif
...
#		define ECSACT_META_API_FN(return_type, fn_name)\
			ECSACT_META_API return_type (*fn_name)
#	else
#		define ECSACT_META_API_FN(return_type, fn_name)\
			ECSACT_META_API return_type fn_name
#	endif

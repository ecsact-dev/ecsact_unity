...
#			ifdef __cplusplus
#				define ECSACT_SERIALIZE_API extern "C" __declspec(dllexport)
#			else
#				define ECSACT_SERIALIZE_API extern __declspec(dllexport)
#			endif
#		else
#			ifdef __cplusplus
#				define ECSACT_SERIALIZE_API extern "C" __declspec(dllimport)
#			else
#				define ECSACT_SERIALIZE_API extern __declspec(dllimport)
#			endif
#		endif
#	else 
#		ifdef ECSACT_SERIALIZE_API_EXPORT
#			ifdef __cplusplus
#				define ECSACT_SERIALIZE_API\
...
#		else
#			ifdef __cplusplus
#				define ECSACT_SERIALIZE_API extern "C"
#			else
#				define ECSACT_SERIALIZE_API extern
#			endif
#		endif
#	endif
...
#		define ECSACT_SERIALIZE_API_FN(return_type, fn_name)\
			ECSACT_SERIALIZE_API return_type (*fn_name)
#	else
#		define ECSACT_SERIALIZE_API_FN(return_type, fn_name)\
			ECSACT_SERIALIZE_API return_type fn_name
#	endif
